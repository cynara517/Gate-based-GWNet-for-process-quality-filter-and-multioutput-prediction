...
from graph_layers import graph_constructor, dilated_inception, mixprop, LayerNorm
...
class MTGNN(nn.Module):
    ...
    def forward(self, history_data: torch.Tensor, idx: int = 5, **kwargs) -> torch.Tensor:
        ...
        if self.gcn_true:
            ...
            with open('adj_6_pen.pkl','wb')as f:
